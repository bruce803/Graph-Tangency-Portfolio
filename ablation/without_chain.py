...
class AGNN(torch.nn.Module):
    ...
    def forward(self, data, r, h, c):
        ...
        return R, w, x, mu, temp, W, pre_r, C
...
for epoch in range(num_epoch):
    ...
    for i,(x,r) in enumerate(train_loader):
        ...
        R, w, x, mu, temp, W, pre_r, C = model_agnn(Gdata, r, h, c)#b,t,n
        ...
        #         torch.save(w, "results/ablation1/1_0.001_0.1agnn195/45/train_w.pth")
        #         torch.save(R, "results/ablation1/1_0.001_0.1agnn2912/45/train_R.pth")
        #         # torch.save(x, "results/ablation1/1_0.001_0.1agnn195/45/train_H.pth")
        #         torch.save(mu, "results/ablation1/1_0.001_0.1agnn195/45/train_mu.pth")
        #         # torch.save(temp, "results/ablation1/1_0.001_0.1agnn195/45/train_sigma的逆.pth")
        #         torch.save(r, "results/ablation1/1_0.001_0.1agnn195/45/train_r.pth")
        optimizer.zero_grad()
    ...
    for i,(x,r) in enumerate(valid_loader):
        ...
        #         torch.save(w, "results/ablation1/1_0.001_0.1agnn195/45/valid_w.pth")
        #         torch.save(R, "results/ablation1/1_0.001_0.1agnn195/45/valid_R.pth")
        #         # torch.save(x, "results/ablation1/1_0.001_0.1agnn195/45/valid_H.pth")
        #         torch.save(mu, "results/ablation1/1_0.001_0.1agnn195/45/valid_mu.pth")
        #         # torch.save(temp, "results/ablation1/1_0.001_0.1agnn195/45/valid_sigma的逆.pth")
        #         torch.save(r, "results/ablation1/1_0.001_0.1agnn195/45/valid_r.pth")
        mse = torch.sum(torch.square(r - pre_r))/ (2912 * r_l * batch_size)
        loss = mse + lo * loss_order 
    ...
    # 保存合并后的张量为文件
    # torch.save(combined_tensor, 'results/ablation1/1_0.001_0.1agnn195/45/R_VAILD.pt')
...
for i,(x,r) in enumerate(test_loader):
    ...
    if i == len(test_loader)-1:
        # torch.save(w, "results/ablation1/1_0.001_0.1agnn195/45/test_w.pth")
        # torch.save(R, "results/ablation1/1_0.001_0.1agnn195/45/test_R.pth")
        # torch.save(x, "results/ablation1/1_0.001_0.1agnn195/45/test_H.pth")
        # torch.save(mu, "results/ablation1/1_0.001_0.1agnn195/45/test_mu.pth")
        # torch.save(temp, "results/ablation1/1_0.001_0.1agnn195/45/test_sigma的逆.pth")
        torch.save(r, "/home/huquan/industrychain/lhl/ablation_result/w_i/test_r.pth")
        torch.save(pre_r,"/home/huquan/industrychain/lhl/ablation_result/w_i/test_pre_r.pth")
...
combined_tensor2 = torch.stack(STDRs_TEST)
    # 保存合并后的张量为文件
# print(combined_tensor)
# torch.save(combined_tensor1, 'D:/stu_perfect/毕业论文/数据集/result/without_chain/R_test.pt')
# torch.save(combined_tensor2, 'D:/stu_perfect/毕业论文/数据集/result/without_chain/stdR_test.pt')
