...
for i,(x,r) in enumerate(test_loader):
    ...
    if i == len(test_loader)-1:
        ...
        torch.save(r,"/home/huquan/industrychain/lhl/backbone_result/A/2/test_r.pth")
        torch.save(pre_r,"/home/huquan/industrychain/lhl/backbone_result/A/2/test_pre_r.pth")
