...
class AGNN(torch.nn.Module):
    def __init__(self):
        ...
        # 图滤波层，使用GCN
        self.Cheb_1 = ChebConv(161, 100, K=1)
        self.Cheb_2 = ChebConv(100, 50, K=1)
    ...
    def forward(self, data, r, h, c):
        ...
        x = self.Cheb_1(x, edge_index)# x[batch,T,stock,feature]
        x = torch.tanh(x)
        x = self.Cheb_2(x, edge_index)# x[batch,T,stock,feature]
        x = torch.tanh(x)
...
for epoch in range(num_epoch):
    ...
    for i,(x,r) in enumerate(train_loader):
        ...
        #         torch.save(w, "results/GNNs/Cheb/train_w.pth")
        #         torch.save(R, "results/GNNs/Cheb/train_R.pth")
        #         # torch.save(x, "results/GNNs/Cheb/train_H.pth")
        #         torch.save(mu, "results/GNNs/Cheb/train_mu.pth")
        #         # torch.save(temp, "results/GNNs/Cheb/train_sigma的逆.pth")
        #         torch.save(r, "results/GNNs/Cheb/train_r.pth")
        optimizer.zero_grad()
    ...
    for i,(x,r) in enumerate(valid_loader):
        ...
        #         torch.save(w, "results/GNNs/Cheb/valid_w.pth")
        #         torch.save(R, "results/GNNs/Cheb/valid_R.pth")
        #         # torch.save(x, "results/GNNs/Cheb/valid_H.pth")
        #         torch.save(mu, "results/GNNs/Cheb/valid_mu.pth")
        #         # torch.save(temp, "results/GNNs/Cheb/valid_sigma的逆.pth")
        #         torch.save(r, "results/GNNs/Cheb/valid_r.pth")
...
for i,(x,r) in enumerate(test_loader):
    ...
    if i == len(test_loader)-1:
        ...
        torch.save(r, "/home/huquan/industrychain/lhl/backbone_result/C/2/test_r.pth")
        torch.save(pre_r,"/home/huquan/industrychain/lhl/backbone_result/C/2/test_pre_r.pth")
