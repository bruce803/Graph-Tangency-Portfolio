...
from torch_geometric.nn import GATConv, ChebConv, GCNConv, GeneralConv, SAGEConv, SSGConv
...
class AGNN(torch.nn.Module):
    def __init__(self):
        ...
        # 图滤波层，使用GCN
        self.conv_1 = SSGConv(161, 100, alpha=0.2)
        self.conv_2 = SSGConv(100, 50, alpha=0.2)
...
for i,(x,r) in enumerate(test_loader):
    ...
    if i == len(test_loader)-1:
        ...
        torch.save(pre_r,"/home/huquan/industrychain/lhl/backbone_result/S/3/test_pre_r.pth")
        torch.save(r, "/home/huquan/industrychain/lhl/backbone_result/S/3/test_r.pth")
